...
const saurabhData = {
 ...
 console.log(saurabhData.fname);  //saurabh
 console.log(saurabhData.Education);  //B.tech
 console.log(saurabhData["age"]);  //25
 console.log(saurabhData.employment.salary);  //5000000
 console.log(saurabhData["employment"].salary);  //5000000
 console.log(saurabhData["employment"]["salary"]);  //5000000
 console.log(saurabhData.marks[2]);  //10
