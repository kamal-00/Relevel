...
const num = "99"; 
console.log("Num before passing to function", num); //Num before passing to function 99
// we are passing value not address
const result = passByValue(num);
console.log("Result ",result); //Result  9910
// num is not updated because address was not passed.
console.log("Num after passing to function", num); //Num after passing to function 99 